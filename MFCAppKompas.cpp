...
// MFCAppKompas.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCAppKompasApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCAppKompasApp

CMFCAppKompasApp::CMFCAppKompasApp()
{
...
// Единственный объект CMFCAppKompasApp

CMFCAppKompasApp theApp;


// Инициализация CMFCAppKompasApp

BOOL CMFCAppKompasApp::InitInstance()
{
